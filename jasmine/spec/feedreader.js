...
$(function() {
    ...
    */
    ...
    describe('RSS Feeds', function() {
         ...
         * page?----->Expected 0 not to be 0.
         */

    let feedUrl = allFeeds[0].url;
   ...
   const body = document.getElementsByClassName('menu-hidden');
      ...
      it('element should be hidden by default', function() {
          ...
          */
       it('element should show when menu icon clicked and hide when clicked again', function() {
    ...
    describe('Initial Entries', function() {
        ...
        //Test that LoadFeed() is working with initial entries.
    ...
    describe('New Feed Selection', function() {
      ...
      //Test that loadFeed function is working with new entries.
      it('should be added and content changed when new feed is loaded',function() {
